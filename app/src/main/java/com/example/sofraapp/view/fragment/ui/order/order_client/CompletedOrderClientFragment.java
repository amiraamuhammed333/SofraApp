...
public class CompletedOrderClientFragment extends BaseFragment {
    View view;
    Unbinder unbinder;
    LinearLayoutManager linearLayoutManager;
    OrderClientAdapter currentOrderClientAdapter;
    List<OrderClientData> currentOrderClientDataList = new ArrayList<>();
    @BindView(R.id.completed_order_client_recycleview)
    RecyclerView completedOrderClientRecycleview;
    ...
    public CompletedOrderClientFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.completed_order_client, container, false);
    ...
    private void iniRecyclerView() {
        ...
        completedOrderClientRecycleview.setLayoutManager(linearLayoutManager);
       ...
       completedOrderClientRecycleview.addOnScrollListener(onEndless);
        currentOrderClientAdapter = new OrderClientAdapter(getActivity(), getActivity(), currentOrderClientDataList);
        completedOrderClientRecycleview.setAdapter(currentOrderClientAdapter);
        getCurrentOrder(1);
    }

    public void getCurrentOrder(int page) {
        APIManger.getApis().getCurrentOrderClient("HRbqKFSaq5ZpsOKITYoztpFZNylmzL9elnlAThxZSZ52QWqVBIj8Rdq7RhoB", "completed ").
